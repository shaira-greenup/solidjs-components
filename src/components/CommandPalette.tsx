...
const CommandSeparator: Component<VoidProps<CommandPrimitive.CommandSeparatorProps>> = (props) => {
  ...
  return <CommandPrimitive.CommandSeparator class={cn("h-px bg-base-300", local.class)} {...others} />;
};
...
const CommandShortcut: Component<ComponentProps<"span">> = (props) => {
  ...
  return (
    <span
      class={cn("ml-auto text-xs tracking-widest text-base-content/50", local.class)}
      {...others}
    />
  );
};
